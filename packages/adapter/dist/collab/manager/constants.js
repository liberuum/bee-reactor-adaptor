...
export const LS_SUMMARIES_KEY = "swarm:collabs";
/** Prefix for per-(collab, peer, doc) feed cursor keys. */
export const LS_PEER_CURSOR_PREFIX = "swarm:collabPeerCursor:";
