...
export declare function buildCollabId(kind: CollabKind, driveId: string, documentId?: string): CollabId;
/** Collaboration manifest feed — owned by the initiator. */
export declare function collabManifestTopic(collabId: CollabId): string;
/** Per-participant drive-level ops feed for a collab. */
export declare function collabDriveOpsTopic(collabId: CollabId, driveId: string): string;
/** Per-participant document-level ops feed for a collab. */
export declare function collabDocOpsTopic(collabId: CollabId, driveId: string, documentId: string): string;
