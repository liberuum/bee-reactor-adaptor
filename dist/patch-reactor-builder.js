...
export function patchReactorBuilder(ReactorBuilder) {
    ...
    proto.buildModule = async function (...args) {
        ...
        const customOpStore = this.operationStoreInstance;
        const customKfStore = this.keyframeStoreInstance;
...
//# sourceMappingURL=patch-reactor-builder.js.map