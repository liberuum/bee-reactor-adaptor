...
export type Type<From_, To> = From<From_, To> & Partial<Descriptive & Displayed & Default<To> & OnMissing<To>>;
/**
 ...
 */
export declare function extendType<BaseType extends Type<any, any>, NextType extends Type<OutputOf<BaseType>, any> | FromFn<OutputOf<BaseType>, any>>(base: BaseType, nextTypeOrDecodingFunction: NextType): Omit<BaseType, "from" | "defaultValue" | "onMissing"> & (NextType extends FromFn<any, any> ? unknown : Omit<NextType, "from">) & From<InputOf<BaseType>, OutputOf<NextType>>;
