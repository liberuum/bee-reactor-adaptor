 ...
 */
export declare const ExistingPath: Omit<import("..").Type<string, string>, "from" | "defaultValue" | "onMissing"> & Omit<{
    displayName: string;
    description: string;
 ...
 */
export declare const Directory: Omit<Omit<import("..").Type<string, string>, "from" | "defaultValue" | "onMissing"> & Omit<{
    displayName: string;
    description: string;
    from(str: string): Promise<string>;
}, "from"> & import("../from").From<string, string>, "from" | "defaultValue" | "onMissing"> & Omit<{
 ...
 */
export declare const File: Omit<Omit<import("..").Type<string, string>, "from" | "defaultValue" | "onMissing"> & Omit<{
    displayName: string;
    description: string;
    from(str: string): Promise<string>;
}, "from"> & import("../from").From<string, string>, "from" | "defaultValue" | "onMissing"> & Omit<{
