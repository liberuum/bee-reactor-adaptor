...
type FlagConfig<Decoder extends Type<boolean, any>> = LongDoc & HasType<Decoder> & Partial<ShortDoc & Descriptive & EnvDoc & OnMissing<OutputOf<Decoder>>> & AllOrNothing<Default<OutputOf<Decoder>>>;
/**
...
export declare function flag(config: LongDoc & Partial<HasType<never> & ShortDoc & Descriptive & EnvDoc & OnMissing<OutputOf<BooleanType>>> & AllOrNothing<Default<OutputOf<BooleanType>>>): ArgParser<OutputOf<BooleanType>> & ProvidesHelp & Register & Partial<Descriptive>;
export {};
